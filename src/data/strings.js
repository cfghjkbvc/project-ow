...
const STR = {
  en: {
    ...
    shareGame: "Share the game", shareBody: "Point a camera at this and the game opens. Nothing to install.",
    shareText: "A deduction party game for one phone.", copyLink: "Copy the link", shareVia: "Share…",
    about: "About", versionN: (v) => `Version ${v}`,
    aboutBlurb: "Most of you share a word. One or two hold something close but different — and nobody is told which they are.",
    theDeck: "The deck", theGame: "The game", theCards: "The cards", theLayout: "The layout", theType: "The type",
    deckCounts: (en, hu, own) => `${en} English pairs, ${hu} Hungarian, ${own} of your own.`,
    creditGenre: "A variant of the Undercover and Spyfall family of social deduction games. The mechanic is nobody's property.",
    creditArt: "Illustrations generated with AI, so they are not claimed as anyone's work.",
    creditLayout: "Card structure after the Tarot de Marseille, which has been in the public domain for a long time.",
    creditFonts: "Abril Fatface, Bodoni Moda and Jost, under the SIL Open Font License.",
    readLicence: "Read the licence",
    yourData: "Your data", madeFor: "Made for a specific group of friends, which is why the words are the way they are.",
    yourDataBody: "Players, packs, scores and history live on this phone only. Nothing is sent anywhere, and clearing your browser data will take them with it.",
    wipeAll: "Erase everything", wipeConfirm: "Erase it all",
    wipeBody: "Players, custom packs, retired pairs, scores and history — all of it, permanently. The built-in decks stay.",
    backup: "Backup", saveIt: "Keep a copy", bringItBack: "Bring it back",
    backupWhy: "Everything lives on this phone and nowhere else. Clearing your browser data, losing the phone, or iOS reclaiming storage from a site you rarely open will all take it with them.",
    playersLbl: "Players", pairsLbl: "Your pairs",
    saveFile: "Save a file", copyText: "Copy as text", saved: "Saved",
    loadFile: "Load a file", pasteBackup: "Paste a backup",
    bringItBackBody: "Files are awkward on phones, so pasting the text works just as well.",
    pastePlaceholder: "Paste the backup text here", readIt: "Read it",
    foundBackup: "Found a backup",
    backupSummary: (pl, pk, pr) => `${pl} players, ${pk} packs, ${pr} pairs.`,
    madeOn: (d) => `Made on ${d}.`,
    mergeIt: "Add it to what I have",
    mergeNote: "Adds players and packs you don't already have. Nothing is overwritten.",
    replaceIt: "Replace everything",
    saveFailed: "That didn't work. Try the other option.",
    backupUnreadable: "That file could not be read.",
    notOurBackup: "That isn't an Odd Word backup.",
    backupTooNew: "That backup is from a newer version of the game.",
    pasteList: "Paste a list",
    pasteListHelp: "One pair per line. Slash, comma, semicolon or dash all work. Add a number 1-4 at the end to set how close they are.",
    addThem: "Add them", nothingToAdd: "No usable pairs in that.",
    addedN: (n, bad) => bad ? `Added ${n}. Skipped ${bad}.` : `Added ${n}.`,
    searchPairs: "Search the deck", matchesN: (n) => `${n} matching`,
    noMatches: "Nothing matches that.", removedN: (n) => `${n} removed`,
    removedChip: "Removed", editPair: "Edit the pair", thisPair: "This pair",
    savePair: "Save it", deletePair: "Delete it",
    removeFromPlay: "Remove from play", restorePair: "Put it back in",
    builtInNote: "A built-in deck can't be edited in place, but you can drop pairs out of play, or copy the whole deck and change your copy freely.",
    copyToNew: "Copy this deck to edit", copyOf: (n) => `${n} (copy)`,
  ...
  hu: {
    ...
    shareGame: "Játék megosztása", shareBody: "Irányíts rá egy kamerát, és megnyílik a játék. Nem kell telepíteni semmit.",
    shareText: "Kakukktojás-játék egyetlen telefonra.", copyLink: "Link másolása", shareVia: "Megosztás…",
    about: "Névjegy", versionN: (v) => `${v} verzió`,
    aboutBlurb: "A többségnél ugyanaz a szó van. Egynél-kettőnél valami közeli, de más — és senki sem tudja magukról, melyik ő.",
    theDeck: "A pakli", theGame: "A játék", theCards: "A lapok", theLayout: "A forma", theType: "A betűk",
    deckCounts: (en, hu, own) => `${hu} magyar páros, ${en} angol, és ${own} a sajátod.`,
    creditGenre: "Az Undercover és a Spyfall társasjáték-család egy változata. A játékmenet senki tulajdona.",
    creditArt: "Az illusztrációk AI-val készültek, ezért nem is tekintjük senki művének.",
    creditLayout: "A lapok felépítése a Marseille-i tarot után, ami már régen közkinccsé vált.",
    creditFonts: "Abril Fatface, Bodoni Moda és Jost, SIL Open Font License alatt.",
    readLicence: "Licenc megtekintése",
    yourData: "Az adataid", madeFor: "Egy konkrét baráti társaságnak készült — ezért ilyenek a szavak.",
    yourDataBody: "A játékosok, paklik, pontok és a történet csak ezen a telefonon vannak. Semmi nem megy sehová, és a böngészőadatok törlése ezeket is elviszi.",
    wipeAll: "Minden törlése", wipeConfirm: "Törölj mindent",
    wipeBody: "Játékosok, saját paklik, kidobott párosok, pontok és történet — mind, véglegesen. A beépített paklik megmaradnak.",
    backup: "Mentés", saveIt: "Készíts másolatot", bringItBack: "Visszatöltés",
    backupWhy: "Minden csak ezen a telefonon van. A böngészőadatok törlése, a telefon elvesztése vagy az, ha az iOS felszabadítja a helyet egy ritkán használt oldaltól, mindent elvisz.",
    playersLbl: "Játékosok", pairsLbl: "Saját párosok",
    saveFile: "Fájl mentése", copyText: "Másolás szövegként", saved: "Elmentve",
    loadFile: "Fájl betöltése", pasteBackup: "Mentés beillesztése",
    bringItBackBody: "Telefonon a fájlok kényelmetlenek, ezért a szöveg beillesztése is ugyanúgy működik.",
    pastePlaceholder: "Ide illeszd be a mentés szövegét", readIt: "Beolvasás",
    foundBackup: "Találtam egy mentést",
    backupSummary: (pl, pk, pr) => `${pl} játékos, ${pk} pakli, ${pr} páros.`,
    madeOn: (d) => `Készült: ${d}.`,
    mergeIt: "Add a mostaniakhoz",
    mergeNote: "Csak azt adja hozzá, ami még nincs meg. Semmi nem íródik felül.",
    replaceIt: "Cseréld le mindet",
    saveFailed: "Ez nem sikerült. Próbáld a másik módot.",
    backupUnreadable: "Ezt a fájlt nem sikerült beolvasni.",
    notOurBackup: "Ez nem Odd Word mentés.",
    backupTooNew: "Ez a mentés a játék újabb verziójából származik.",
    pasteList: "Lista beillesztése",
    pasteListHelp: "Soronként egy páros. Perjel, vessző, pontosvessző vagy gondolatjel is jó. A sor végére írt 1-4 szám adja meg, mennyire közeliek.",
    addThem: "Hozzáadás", nothingToAdd: "Ebben nincs használható páros.",
    addedN: (n, bad) => bad ? `${n} hozzáadva. ${bad} kihagyva.` : `${n} hozzáadva.`,
    searchPairs: "Keresés a pakliban", matchesN: (n) => `${n} találat`,
    noMatches: "Erre nincs találat.", removedN: (n) => `${n} kivéve`,
    removedChip: "Kivéve", editPair: "Páros szerkesztése", thisPair: "Ez a páros",
    savePair: "Mentés", deletePair: "Törlés",
    removeFromPlay: "Vedd ki a játékból", restorePair: "Tedd vissza",
    builtInNote: "A beépített paklit nem lehet átírni, de párosokat kivehetsz a játékból, vagy lemásolhatod az egészet, és a másolatot szabadon szerkesztheted.",
    copyToNew: "Másolat szerkesztéshez", copyOf: (n) => `${n} (másolat)`,
