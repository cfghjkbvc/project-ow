...
const STR = {
  en: {
    ...
    play: "Start the night", continueNight: "Carry on", settings: "Settings",
    back: "Back", theNight: "The night", whoIsHere: "Who's here tonight?",
    playingN: (n) => `${n} playing`, noPlayers: "Nobody at the table yet",
    addFirstPlayers: "Add everyone who ever plays. You only type them once — after that you just tick who turned up.",
    allHere: "Everyone", noneHere: "Nobody",
    leading: (n) => `${n} leading`,
    finishNight: "Finish the night",
    finishNightBody: "Scores and round history are cleared and you get the final standings. Your players and packs stay.",
    nightOver: "That's the night", champion: "Champion", championPlural: "Champions",
    nobodyScored: "Nobody scored", pointsN: (n) => `${n} points`,
    roundsPlayed: "Rounds", finalStandings: "Final standings", closeNight: "Back to the start",
    gotAwayWith: (n, c) => `${n} got away with it ${c}× as an impostor.`,
    ...
    gh_wide: "A little more room to separate the two. The friendlier end.",
  ...
  hu: {
    ...
    play: "Este indul", continueNight: "Folytatás", settings: "Beállítások",
    back: "Vissza", theNight: "Az este", whoIsHere: "Ki van ma itt?",
    playingN: (n) => `${n} játszik`, noPlayers: "Még senki nincs az asztalnál",
    addFirstPlayers: "Add meg mindenkit, aki valaha játszik. Csak egyszer kell beírni — utána már csak kipipálod, ki jött el.",
    allHere: "Mindenki", noneHere: "Senki",
    leading: (n) => `${n} vezet`,
    finishNight: "Este lezárása",
    finishNightBody: "A pontok és a körtörténet törlődnek, és megkapod a végeredményt. A játékosok és a paklik megmaradnak.",
    nightOver: "Ennyi volt az este", champion: "Győztes", championPlural: "Győztesek",
    nobodyScored: "Senki nem szerzett pontot", pointsN: (n) => `${n} pont`,
    roundsPlayed: "Körök", finalStandings: "Végeredmény", closeNight: "Vissza az elejére",
    gotAwayWith: (n, c) => `${n} ${c}× úszta meg beépülőként.`,
    ...
    gh_wide: "Kicsit több esély szétválasztani a kettőt. A békésebb vége.",
